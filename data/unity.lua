...
-- ==============================================================================
for r = 1, 15 do
    unity_tables[r][20709] = { ['A'] = expand_stats(demers_degen['A'][r]) } -- Demers. Degen +1
    unity_tables[r][20609] = { ['A'] = expand_stats(jugo_kukri['A'][r]) } -- Jugo Kukri +1
    unity_tables[r][21091] = { ['A'] = expand_stats(loxotic_mace['A'][r]) } -- Loxotic Mace +1
    unity_tables[r][20805] = { ['A'] = expand_stats(perun['A'][r]) } -- Perun +1
    unity_tables[r][20613] = { ['A'] = expand_stats(pukulatmuj['A'][r]) } -- Pukulatmuj +1
    unity_tables[r][20604] = { ['A'] = expand_stats(ternion_dagger['A'][r]) } -- Ternion Dagger +1
    unity_tables[r][22058] = { ['A'] = expand_stats(contemplator['A'][r]) } -- Contemplator +1
    unity_tables[r][21100] = { ['A'] = expand_stats(magesmasher['A'][r]) } -- Magesmasher +1
    unity_tables[r][21160] = { ['A'] = expand_stats(marin_staff['A'][r]) } -- Marin Staff +1
    unity_tables[r][22267] = { ['A'] = expand_stats(antitail['A'][r]) } -- Antitail +1
    unity_tables[r][21350] = { ['A'] = expand_stats(wingcutter['A'][r]) } -- Wingcutter +1
    unity_tables[r][21417] = { ['A'] = expand_stats(refined_grip['A'][r]) } -- Refined Grip +1
    unity_tables[r][21344] = { ['A'] = expand_stats(ghastly_tathlum['A'][r]) } -- Ghastly Tathlum +1
    
    unity_tables[r][25602] = { ['A'] = expand_stats(blistering_sallet['A'][r]) } -- Blistering Sallet +1
    unity_tables[r][25636] = { ['A'] = expand_stats(loess_barbuta['A'][r]) } -- Loess Barbuta +1
    unity_tables[r][26871] = { ['A'] = expand_stats(emet_harness['A'][r]) } -- Emet Harness +1
    unity_tables[r][26888] = { ['A'] = expand_stats(shomonjijoe['A'][r]) } -- Shomonjijoe +1
    unity_tables[r][25681] = { ['A'] = expand_stats(cohort_cloak['A'][r]) } -- Cohort Cloak +1
    unity_tables[r][25733] = { ['A'] = expand_stats(tatena_harama['A'][r]) } -- Tatena. Harama. +1
    unity_tables[r][27151] = { ['A'] = expand_stats(gazu_bracelets['A'][r]) } -- Gazu Bracelets +1
    unity_tables[r][27109] = { ['A'] = expand_stats(lamassu_mitts['A'][r]) } -- Lamassu Mitts +1
    unity_tables[r][27107] = { ['A'] = expand_stats(asteria_mitts['A'][r]) } -- Asteria Mitts +1
    unity_tables[r][27149] = { ['A'] = expand_stats(tatena_gote['A'][r]) } -- Tatena. Gote +1
    unity_tables[r][28135] = { ['A'] = expand_stats(assid_pants['A'][r]) } -- Assid. Pants +1
    unity_tables[r][25856] = { ['A'] = expand_stats(tatena_haidate['A'][r]) } -- Tatena. Haidate +1
    unity_tables[r][27231] = { ['A'] = expand_stats(zoar_subligar['A'][r]) } -- Zoar Subligar +1
    unity_tables[r][27410] = { ['A'] = expand_stats(hippo_socks['A'][r]) } -- Hippo. Socks +1
    unity_tables[r][27408] = { ['A'] = expand_stats(hygieia_clogs['A'][r]) } -- Hygieia Clogs +1
    ...
    unity_tables[r][27610] = { ['A'] = expand_stats(fi_follet_cape['A'][r]) } -- Fi Follet Cape +1
    unity_tables[r][10769] = { ['A'] = expand_stats(gelatinous_ring['A'][r]) } -- Gelatinous Ring +1
    unity_tables[r][28491] = { ['A'] = expand_stats(handlers_earring['A'][r]) } -- Handler's Earring +1
    unity_tables[r][28413] = { ['A'] = expand_stats(kentarch_belt['A'][r]) } -- Kentarch Belt +1
    unity_tables[r][26002] = { ['A'] = expand_stats(loricate_torque['A'][r]) } -- Loricate Torque +1
    unity_tables[r][28482] = { ['A'] = expand_stats(lugra_earring['A'][r]) } -- Lugra Earring +1
    unity_tables[r][27559] = { ['A'] = expand_stats(mephitas_ring['A'][r]) } -- Mephitas's Ring +1
    unity_tables[r][27563] = { ['A'] = expand_stats(metamor_ring['A'][r]) } -- Metamor. Ring +1
    unity_tables[r][28485] = { ['A'] = expand_stats(nourish_earring['A'][r]) } -- Nourish. Earring +1
    unity_tables[r][27549] = { ['A'] = expand_stats(odnowa_earring['A'][r]) } -- Odnowa Earring +1
    unity_tables[r][28428] = { ['A'] = expand_stats(sailfi_belt['A'][r]) } -- Sailfi Belt +1
    unity_tables[r][28424] = { ['A'] = expand_stats(shinjutsu_no_obi['A'][r]) } -- Shinjutsu-no-Obi +1
    unity_tables[r][22255] = { ['A'] = expand_stats(seeth_bomblet['A'][r]) } -- Seeth. Bomblet +1
    unity_tables[r][27509] = { ['A'] = expand_stats(unmoving_collar['A'][r]) } -- Unmoving Collar +1
    unity_tables[r][26022] = { ['A'] = expand_stats(vim_torque['A'][r]) } -- Vim Torque +1
    unity_tables[r][27505] = { ['A'] = expand_stats(warders_charm['A'][r]) } -- Warder's Charm +1
end
